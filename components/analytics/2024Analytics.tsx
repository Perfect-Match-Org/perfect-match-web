            ...
            <div>
                ...
                <section className="pt-12 sm:pt-12 lg:pt-16 sm:pb-5 pb-1">
                    <div className="text-center mt-6">
                        <label htmlFor="viz-select-gender" className="text-lg font-semibold mr-4 font-dela-gothic text-pmred-500">
                            Viz by Gender:
                        </label>
                        <select
                    ...
                    <div className="text-center mt-6">
                        <label htmlFor="viz-select-state" className="text-lg font-semibold mr-4 font-dela-gothic text-pmred-500">
                            Viz by State:
                        </label>
                        <select
                            id="viz-select-state"
                    ...
                    <div className="text-center mt-6">
                        <label htmlFor="viz-select-college" className="text-lg font-semibold mr-4 font-dela-gothic text-pmred-500">
                            Viz by College:
                        </label>
                        <select
                    ...
                    <div className="text-center mt-6">
                        <label htmlFor="viz-select-year" className="text-lg font-semibold mr-4 font-dela-gothic text-pmred-500">
                            Viz by Year:
                        </label>
                        <select
                            id="viz-select-year"
                ...
                <div className="bg-pmpink-500">
                    <div className="left-0 w-full relative h-[60px]">
                        <svg
                            className="absolute top-1 w-full h-[60px] z-100 md:hidden" // Adjust height as needed
                        ...
                        >
                            <path
                                ...
                                className="fill-pmpink2-500"
                            ></path>
                        </svg>
                        <svg
                            className="relative hidden w-full h-[60px] md:block" // Adjust height as needed
                            viewBox="0 0 1200 120"
                            preserveAspectRatio="none"
                        >
                            <path
