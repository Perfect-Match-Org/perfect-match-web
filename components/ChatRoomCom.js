...
export function ChatRoomCom({ current_chat_room_id, sender, receiver }) {
    ...
    return (
        ...
        <div>
            ...
            <header className=" ">
                <div className="fixed w-full bg-rose-400 px-4 py-6 sm:px-6 lg:px-8">
                    <h1 className="text-3xl font-bold tracking-tight text-stone-200">Chats</h1>
                </div>
            </header>
            ...
            <div className="fixed bottom-0 w-full py-3 bg-white flex items-center">
                <input
                    value={inputMessage}
