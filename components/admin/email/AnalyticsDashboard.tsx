// components/admin/email/AnalyticsDashboard.tsx
...
export default function AnalyticsDashboard() {
  ...
  const fetchAnalytics = async () => {
    try {
      ...
      const response = await fetch(`/admin/email/analytics/overview?days=${timeRange}`);
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatNumber(analytics.totals.campaigns)}
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatNumber(analytics.totals.sent)}
                </p>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 mb-1">
                {analytics.rates.unsubscribe_rate}%
              </div>
