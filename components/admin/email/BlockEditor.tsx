        ...
        <div className="grid grid-cols-2 gap-4">
            <div>
                ...
                <select
                    ...
                    className="w-full rounded-xl border border-gray-200 px-3 py-2 text-sm text-gray-700 focus:border-pink-300 focus:outline-none focus:ring-4 focus:ring-pink-500/10"
                >
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 focus:border-pink-300 focus:outline-none focus:ring-4 focus:ring-pink-500/10"
                    placeholder="20px"
                />
            </div>
        </div>
