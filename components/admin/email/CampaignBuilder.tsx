							...
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
								{templates.map((template) => (
									<div
										...
										className={`group relative border-2 rounded-md p-4 cursor-pointer transition-all duration-300 ${
						...
						{[1, 2, 3].map((step) => {
							...
							return (
								<div key={step} className="relative z-10 flex flex-col items-center">
									<div
										className={`flex items-center justify-center w-10 h-10 rounded-md border-2 transition-all duration-300 ${
											isCompleted
