// components/admin/email/EmailDashboard.tsx
...
export default function EmailDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const campaignResponse = await fetch('/admin/email/campaigns/stats');
      ...
      const recentResponse = await fetch('/admin/email/campaigns?limit=5');
      if (recentResponse.ok) {
        ...
        const formattedCampaigns = recentData.campaigns.map((campaign: any) => ({
          ...
          openRate: campaign.analytics?.delivered_count > 0 
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            <button className="px-6 py-3 rounded-lg text-white font-medium transition-all duration-200 hover:shadow-lg"
                    style={{ 
            ...
            <button className="px-6 py-3 rounded-lg border-2 font-medium transition-all duration-200 hover:shadow-lg"
                    style={{ 
            ...
            <button className="px-6 py-3 rounded-lg bg-gray-100 text-gray-700 font-medium transition-all duration-200 hover:bg-gray-200"
