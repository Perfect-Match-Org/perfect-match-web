            ...
            <div className="bg-white rounded-lg shadow-lg p-1 flex">
                <button
                    ...
                    className={`px-6 py-3 rounded-md font-semibold transition-all duration-200 ${
                        activeTab === "pending" ? "bg-pmred-500 text-white shadow-md" : "text-gray-700 hover:bg-gray-100"
                    }`}
                >
                ...
                <button
                    ...
                    className={`px-6 py-3 rounded-md font-semibold transition-all duration-200 ${
                        activeTab === "existing" ? "bg-pmred-500 text-white shadow-md" : "text-gray-700 hover:bg-gray-100"
                    }`}
                >
