            ...
            <div className="px-4 sm:py-20 bg-lightblue">
                <div className="fle max-w-6xl mx-auto text-gray-600">
                    <dl className="w-full md:w-full">
                        <h2 className="pt-12 pb-6 w-full sm:py-4 mr-8 text-3xl text-pmred-500 font-extrabold leading-9 md:w-1/3">Status</h2>
                        ...
                        <p className={props?.surveyComplete ? "mb-4 font-bold text-green-500" : "mb-4 font-bold text-red-400"}>
                            {props?.surveyComplete
                                ? "You have completed the survey!"
                                : "We are still waiting for you to complete the survey."}
                        </p>
                        <p className={props?.profileComplete ? "mb-4 font-bold text-green-500" : "mb-4 font-bold text-red-400"}>
                        ...
                        <ol className="mb-8 list-decimal list-inside">
                            ...
                            <li>
                                &#91;Required&#93;<strong> Opt In</strong> &#40;right below&#41; to indicate you are interested in
                                participating.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <strong className="text-rose-400">❗Nudge your crush with an anonymous email!❗</strong>
                            </li>
                        </ol>
                        <dt className="mb-4">
                        ...
                        <dd className="mb-8">
                            <section id="opt" className={props.optIn ? "text-green-500" : "text-red-400"}>
                                <p>
                                    {props.optIn
                                        ? "You are currently opted-in to our 2026 matching process."
                                        : "You are currently opted-out to our 2026 matching process."}
                                </p>
                                {/* Preview Link
                                {props.surveyComplete && (
                                    <a
                            ...
                            <button
                                onClick={handleClick}
                                className={`mt-2 bg-transparent hover:bg-pmred-500 font-semibold hover:text-white py-1 px-2 border hover:border-transparent rounded ${
