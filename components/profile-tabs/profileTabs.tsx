            ...
            <Tab.Group>
                ...
                <Tab.Panels className="mt-2">
                    ...
                    <Tab.Panel className="rounded-xl bg-white p-3">
                        <h2 className="pt-10 w-full sm:pt-20 pb-4 mr-8 text-3xl text-pmred-500 font-extrabold leading-9 md:w-1/3">
                            Profile
                        </h2>
                    ...
                    <Tab.Panel className="rounded-xl bg-white p-3">
                        <h2 className="pt-10 w-full sm:pt-20 pb-4 text-3xl text-pmred-500 font-extrabold leading-9 md:w-1/2">
                            Crushes & Forbidden
                        </h2>
