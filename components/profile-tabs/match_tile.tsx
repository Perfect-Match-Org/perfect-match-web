            ...
            <div className="items-center rounded-lg shadow-lg sm:flex mx-[1%] sm:mx-[6%] lg:mx-[12%]">
                ...
                <div className="p-3 pt-1 sm:pl-10 sm:pr-16 sm:py-5">
                    ...
                    <ul className="flex space-x-4 sm:mt-0">
                        {match_data.survey.contact.insta != "" && (
                            <li>
                                <a href={"https://instagram.com" + match_data.survey.contact.insta} className="text-gray-500 hover:text-gray-900 ">
