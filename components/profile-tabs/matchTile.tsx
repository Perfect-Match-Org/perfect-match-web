                    ...
                    <div className="py-8 px-10 w-full z-10 h-3/4">
                        <div className="flex flex-col lg:flex-row justify-start items-center w-full font-work-sans font-semibold gap-2 md:gap-8 ">
                            <div className="text-pmblue-500 flex flex-col gap-2 lg:text-xl text-base justify-start w-full">
                                {safeContact.insta && isDisplayed('insta') && (<div className="flex items-center">
                                    ...
                                    <p className="ml-2 text-left">Ins: {safeContact.insta.includes('@') ? safeContact.insta : '@' + safeContact.insta} </p>
                                </div>)}
                                {safeContact.phone && isDisplayed('phone') && (<div className="flex items-center">
                                ...
                                {safeContact.email && isDisplayed('email') && (<div className="flex items-center">
                                ...
                                {safeContact.wechat && isDisplayed('wechat') && (<div className="flex items-center">
                                ...
                                {safeContact.fb && isDisplayed('fb') && (<div className="flex items-center">
                                ...
                                {safeContact.linkedin && isDisplayed('linkedin') && (<div className="flex items-center">
                                ...
                                {safeContact.snapchat && isDisplayed('snapchat') && (<div className="flex items-center">
                                ...
                                {safeContact.other && isDisplayed('other') && (<div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 21 22" fill="none">
                                        <circle cx="8.47521" cy="8.70519" r="7.19444" stroke="#00438D" stroke-width="2.5" />
                                        <path d="M18.147 21.2C18.6352 21.6881 19.4267 21.6881 19.9148 21.2C20.403 20.7118 20.403 19.9204 19.9148 19.4322L18.147 21.2ZM12.6054 15.6583L18.147 21.2L19.9148 19.4322L14.3731 13.8905L12.6054 15.6583Z" fill="#00438D" />
                                    </svg>
                        ...
                        <div className="relative rounded-md w-auto mb-5 h-auto mt-3 px-6 py-3 font-work-sans text-sm md:text-lg font-semibold text-pmblue-500 bg-pmpink-500 ">
                            ...
                            <p className="text-left">Favorite romance trope: {poked ? (<span style={{ color: '#F4001F' }}>{romanceTropeStrings[String(matchData.survey.romanceTrope)]}</span>) : (<span className="select-none" style={{ color: '#F4001F', filter: 'blur(5px)' }}>{maskText(romanceTropeStrings[String(matchData.survey.romanceTrope)])}</span>)}</p>
                            ...
                            <p className="text-left">1 = Introvert, 10 = Extrovert, I&apos;m a: {poked ? (<span style={{ color: '#F4001F' }}>{String(matchData.survey.introvert)}</span>) : (<span className="select-none" style={{ color: '#F4001F', filter: 'blur(5px)' }}>{maskText(String(matchData.survey.introvert))}</span>)}</p>
                            <p className="text-left">Favorite song: {poked ? (<span style={{ color: '#F4001F' }}>{matchData.survey.favSong}</span>) : (<span className="select-none" style={{ color: '#F4001F', filter: 'blur(5px)' }}>{maskText(matchData.survey.favSong)}</span>)}</p>
                        </div>
                    </div>
                </div>
            </div >
