        ...
        <div className="pt-16 pb-10 sm:py-6 mx-[5%] sm:mx-[10%] lg:mx-[15%]">
            <div className="container px-5 sm:px-0 py-2 sm:py-20 mx-auto sm:mx-0">
                <div className="text-center mb-0">
                    <h2 className="font-dela-gothic mb-6 text-2xl tracking-tight text-pmblue-500 sm:text-5xl sm:mb-8">Meet the Cupids</h2>
                ...
                {team.map((division, idx) => (
                    <div key={idx}>
                        ...
                        <p
                            className="font-work-sans mb-12 text-center text-pmblue-500 text-base sm:text-lg font-medium max-w-4xl mx-auto px-4"
                                ...
                                division.Members.map((member) => (
                                    ...
                                    >
                                        <div className="flex flex-col items-center">
                                            ...
                                            <p className="font-work-sans text-pmblue-500 text-base font-base text-center">
                                                {member.Title1}
                                            </p>
                                            <p className="font-work-sans text-pmblue-500 text-base font-base text-center">
                                                {member.Title2}
                        ...
                        {idx !== team.length - 1 && <hr className="border-2 border-pmred-500 sm:mt-16 mt-12 w-[100%]" />}
                    </div>
                ))}
            </div>
        </div>
