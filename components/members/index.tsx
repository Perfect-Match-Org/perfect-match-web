        ...
        <div className="pt-16 pb-10 sm:py-6 mx-[5%] sm:mx-[10%] lg:mx-[15%]">
            <div className="container px-5 sm:px-0 py-2 sm:py-20 mx-auto sm:mx-0">
                <div className="text-center mb-0">
                    ...
                    <p className="text-gray-500 italic text-base sm:text-xl mb-10">We currently have seven members, divided into two teams – Engineering and Business.</p>
                    <hr className="border-1 border-rose-300 w-[100%]" />
                </div>

                {team.map((division, idx) => (
                    <div key={idx}>
                        <h3 className="mb-6 text-xl sm:text-3xl text-center font-bold text-gray-700 sm:mt-16 mt-10">{division.Name}</h3>
                        <p className="mb-12 italic text-center text-gray-500 text-sm sm:text-base">{division.Description}</p>
                                    ...
                                    <a key={member.Name} className="sm:w-1/4" href={member.Linkedin} target="_blank" rel="noopener noreferrer">
                                        <div className="flex flex-col items-center">
                                            <Image
                                                ...
                                                loading='eager'
                                            />
                                            <p className="font-semibold sm:text-lg text-gray-700 text-center sm:mt-4 mt-3">{member.Name}</p>
