                            ...
                            <div className="w-full lg:w-1/2 px-4">
                                <details className="mb-5">
                                    ...
                                    <p style={{ paddingTop: '10px', paddingLeft: '15px' }}>
                                        Perfect Match is a matchmaking service for Cornell students and faculty. It uses
                                ...
                                <details className="mb-5">
                                    ...
                                    <p style={{ paddingTop: '10px', paddingLeft: '15px' }}>
                                        There are currently seven members in the team. Each of us focuses on designing,
                                        developing, or marketing; there is no leader, and we make decisions together.
                                    </p>
                                </details>
                            </div>
                            <div className="w-full lg:w-1/2 px-4">
