            ...
            <section className="py-12 px-4 bg-pmpink-500">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-10 mx-20">
                        <h2 className="text-4xl sm:text-3xl font-dm-sans font-extrabold text-white lg:text-5xl opacity-100 bg-pmblue2-800 box-decoration-clone p-2 leading-[1.2]">
                            Share Your Perfect Match Story
                        </h2>
                        <p className="font:semibold mt-4 mx-[10%] sm:mx-0 sm:text-lg text-pmblue-500 sm:leading-relaxed">
                            Your experience matters! By sharing your Perfect Match journey, you help others find their special someone too.
                            Each testimonial brings our community closer together and inspires those still searching.
                        </p>
                        <p className="font:semibold mt-4 mx-[10%] sm:mx-0 sm:text-lg text-pmblue-500 sm:leading-relaxed">
                            Let us know how Perfect Match changed your life, and be part of countless love stories yet to unfold.
                        </p>
                    </div>
                            ...
                            <div className="text-center">
                                <div className="mb-6">
                                    <svg
                                        ...
                                        className="h-20 w-20 mx-auto text-pmred-500"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    >
                            ...
                            <form onSubmit={handleSubmit} className="w-full max-w-4xl mx-auto">
                                <div className="mb-4 sm:mb-6">
                                    <label className="block text-pmred-500 text-lg sm:text-xl font-bold mb-2" htmlFor="title">
                                        Title:{" "}
                                        <span className="text-xs sm:text-sm font-normal">({formData.title.length}/250 characters)</span>
                                    </label>
                                    <input
                                    ...
                                    <div className="flex items-start space-x-2 sm:space-x-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-pmblue-500 text-sm sm:text-base leading-relaxed break-words">
                                                <span className="font-semibold">Please note:</span> By submitting a testimonial, you consent
                                                to Perfect Match displaying your testimonial on the home page. All testimonials are subject
                                                to review and approval before being published.
                                            </p>
                                        </div>
                                    </div>
                                </div>
