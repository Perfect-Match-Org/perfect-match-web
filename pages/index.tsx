            ...
            >
                <div className="mx-auto max-w-screen-xl pt-[70%] pb-10 lg:items-center lg:pt-60 lg:pb-36">
                    <div className="text-center lg:text-left lg:ml-[8%] mt-8 lg:mt-0">
                        <h1 className="text-xl text-gray-600 font-extrabold sm:text-4xl">Want an extra <strong className="mt-1 lg:mt-2 lg:mt-3 block font-extrabold text-rose-400">Perfect Match? </strong></h1>
                        <p className="mt-4 mx-[5%] lg:max-w-lg sm:mx-[10%] lg:mx-0 sm:text-xl text-gray-500 sm:leading-relaxed">
                            <strong className="mt-1 lg:mt-2 lg:mt-3  font-extrabold text-rose-400">NEW: </strong>Give us feedback on your matches and recieve an additional match in 2024!
                        </p>

                        <p className="mx-[5%] sm:mx-[10%] lg:max-w-lg lg:mx-0 mt-4 sm:text-xl text-gray-500 sm:leading-relaxed">
                            Over <strong className="mt-1 lg:mt-2 lg:mt-3  font-extrabold text-rose-400">4500+</strong> Cornellians matched this year!{' '}
                        </p>
                        <p className="mx-[5%] sm:mx-[10%] lg:max-w-lg lg:mx-0 mt-4 sm:text-xl text-gray-500 sm:leading-relaxed">
                        </p>
