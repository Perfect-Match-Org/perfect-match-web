  ...
  return (
    <div>
      ...
      <div className="bg-rose-400">
        <div className="py-0.1 px-3 sm:px-0 flex">
          <div className="flex flex-wrap items-center mx-auto">
            <div>
              <p className="ml-2 font-small text-white sm:text-m">
            ...
            <div className="order-3 mt-2 w-full flex-shrink-0 sm:w-auto sm:ml-5 sm:mt-0">
              <Link href="http://www.google.com">
                <a
                  target="_blank"
                  className="flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-1 my-1 text-sm font-sm text-rose-400 shadow-sm hover:bg-rose-50 sm:text-sm"
                >
                  Apply Here!
                </a>
              </Link>
      ...
      <div>
        <div>
          ...
          <section className="bg-white dark:bg-gray-600">
            <div
              className="gap-6 sm:gap-10 items-center px-0 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:px-6 flex-col sm:flex-row mx-[5%] sm:mx-[15%] sm:py-24 pb-12 pt-16"
            ...
            >
              <div className="font text-gray-500 sm:text-lg dark:text-gray-400 sm:w-7/12">
                ...
                <p className="sm:mb-4 mb-0">
                  ...
                  you with other Cornell students— your Perfect Matches! Last
                  year, we had over 4,200 participants. Share the link with your
                  friends, and help spread some joy in 2023!
                </p>
